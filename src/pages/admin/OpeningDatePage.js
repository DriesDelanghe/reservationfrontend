...
const OpeningDatePage = ({setNameAndLink, setServerError, setShowModal, fetchWithCsrf}) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            setShowModal(true)
            Promise.all([fetchActiveDates(), fetchInactiveDates()]).then(() => setShowModal(false))
                .catch(() => {
        ...
        fetchData().then(e => {
            setActiveDates(activeDates.filter(object => !!object.openingDate))
            setInactiveDates(inactiveDates.filter(object => !!object.openingDate))
        })
    }, [])
        ...
        <div className="accordion" id="accordionPanelsStayOpenExample">
            ...
            <div className="accordion-item">
                ...
                <div id="panelsStayOpen-collapseTwo" className="accordion-collapse collapse"
                    ...
                    <div className="accordion-body container-fluid row">
                        {inactiveDates[0] ? inactiveDates.map((activeDate) => <OpeningDateField
