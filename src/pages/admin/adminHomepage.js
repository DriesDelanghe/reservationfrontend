...
const AdminHomepage = ({credentials, fetchWithCsrf, submitData}) => {
            ...
            <>
                ...
                <Switch>
                    ...
                    <Route exact path={"/admin/reservations"}>
                        <ReservationPage fetchWithCsrf={fetchWithCsrf} setActiveDate={setActiveDate}
                    ...
                    <Route exact path={"/admin/reservations/details"}>
                        <ReservationDetailsPage fetchWithCsrf={fetchWithCsrf} activeDate={activeDate}
